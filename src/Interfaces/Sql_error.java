 ...
 */
public class Sql_error extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Animations/1140-error-outline.gif"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 90, 70));

        message.setFont(new java.awt.Font("Yu Gothic UI Semilight", 0, 24)); // NOI18N
        message.setText("SQL ERROR !! TRY AGAIN ");
        jPanel1.add(message, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, 280, 57));
        ...
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 130, 100, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Sql_error.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
